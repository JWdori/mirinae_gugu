...
import '9_s_youtube.dart';

class video_Body_9_9 extends StatefulWidget {
  video_Body_9_9({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_9_9> {
  ...
  List<String> Questiontitle = ["1. 사", "2. 샤", "3. 서","4. 셔","5. 소","6. 쇼","7. 수","8. 슈","9. 스","10. 시"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_9(
                                id: widget.index,
                              ),
                            ),
