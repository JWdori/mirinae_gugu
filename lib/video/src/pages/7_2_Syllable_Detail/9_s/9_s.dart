                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('ㅅ',style: TextStyle(fontSize: 19.sp+size, fontWeight: FontWeight.bold))
                      ),
                      SizedBox(width: 10.w),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                          text: '사',
                          onTap: () async {
                            await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_9_9(
                              index:1,
                            ),));}
                      ),
                      LearnLevelButton(
