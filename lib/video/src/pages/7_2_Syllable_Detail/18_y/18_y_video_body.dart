...
import '18_y_youtube.dart';

class video_Body_18_18 extends StatefulWidget {
  video_Body_18_18({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_18_18> {
  ...
  List<String> Questiontitle = ["1. 아", "2. 야", "3. 어","4. 여","5. 오","6. 요","7. 우","8. 유","9. 으","10. 이"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_18(
                                id: widget.index,
                              ),
                            ),
