...
import '6_dd_youtube.dart';

class video_Body_6_6 extends StatefulWidget {
  video_Body_6_6({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_6_6> {
  ...
  List<String> Questiontitle = ["1. 따", "2. 땨", "3. 떠","4. 뗘","5. 또","6. 뚀","7. 뚜","8. 뜌","9. 뜨","10. 띠"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_6(
                                id: widget.index,
                              ),
                            ),
