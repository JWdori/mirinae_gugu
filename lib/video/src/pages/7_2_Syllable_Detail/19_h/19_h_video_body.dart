...
import '19_h_youtube.dart';

class video_Body_19_19 extends StatefulWidget {
  video_Body_19_19({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_19_19> {
  ...
  List<String> Questiontitle = ["1. 하", "2. 햐", "3. 허","4. 혀","5. 호","6. 효","7. 후","8. 휴","9. 흐","10. 히"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_19(
                                id: widget.index,
                              ),
                            ),
