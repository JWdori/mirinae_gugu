...
import '3_p_youtube.dart';

class video_Body_3_3 extends StatefulWidget {
  video_Body_3_3({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_3_3> {
  ...
  List<String> Questiontitle = ["1. 파", "2. 퍄", "3. 퍼","4. 펴","5. 포","6. 표","7. 푸","8. 퓨","9. 프","10. 피"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_3(
                                id: widget.index,
                              ),
                            ),
