                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: Text('ㅂ',style: TextStyle(fontSize: 19.sp+size, fontWeight: FontWeight.bold))
                          ),
                          SizedBox(width: 10.w),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                              text: '바',
                              onTap: () async {
                                await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_1_1(
                                  index:1,
                                ),));
                              }
                          ),
