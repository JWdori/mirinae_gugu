                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('ㄷ',style: TextStyle(fontSize: 19.sp+size, fontWeight: FontWeight.bold))
                      ),
                      SizedBox(width: 10.w),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                          text: '다',
                          onTap: () async {
                            await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_5_5(
                              index:1,
                            ),));
                          }
                      ),
