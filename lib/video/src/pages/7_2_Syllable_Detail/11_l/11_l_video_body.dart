...
import '11_l_youtube.dart';

class video_Body_11_11 extends StatefulWidget {
  video_Body_11_11({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_11_11> {
  ...
  List<String> Questiontitle = ["1. 라", "2. 랴", "3. 러","4. 려","5. 로","6. 료","7. 루","8. 류","9. 르","10. 리"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_11(
                                id: widget.index,
                              ),
                            ),
