...
class video_page_11 extends StatefulWidget {
  const video_page_11({
    Key ?key,
    required this.id,
  }) : super(key: key);
...
class _5_video_page extends State<video_page_11>{
  ...
  List asd = ['rHQqd7PPF7k','oFBq8pEZZSQ','B8UJahAioZo','lZUr_y3d85E','hJ22d75jBf0','guwQORQy6yY','LaSBBDL47TE','vLRugQ5_6Eo','H880SVi_pkk','EDXlyjKjZKY'];
