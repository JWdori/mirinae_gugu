...
import '4_m_youtube.dart';

class video_Body_4_4 extends StatefulWidget {
  video_Body_4_4({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_4_4> {
  ...
  List<String> Questiontitle = ["1. 마", "2. 먀", "3. 머","4. 며","5. 모","6. 묘","7. 무","8. 뮤","9. 므","10. 미"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_4(
                                id: widget.index,
                              ),
                            ),
