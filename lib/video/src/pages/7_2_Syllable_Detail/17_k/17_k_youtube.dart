...
class video_page_17 extends StatefulWidget {
  const video_page_17({
    Key ?key,
    required this.id,
  }) : super(key: key);
...
class _5_video_page extends State<video_page_17>{
  ...
  List asd = ['e-8TiUOlfZU','70xnsyMxv8A','NlXiqFa52oo','Gfi89GirwyA','zINsYfRB9WE','niBZeeioNGI','I-eWRK_ofVo','EBq90S5E3OQ','cNhtwB0gknI','26Zbhd6Qbqk'];
