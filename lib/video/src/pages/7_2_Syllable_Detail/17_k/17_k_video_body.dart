...
import '17_k_youtube.dart';

class video_Body_17_17 extends StatefulWidget {
  video_Body_17_17({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_17_17> {
  ...
  List<String> Questiontitle = ["1. 카", "2. 캬", "3. 커","4. 켜","5. 코","6. 쿄","7. 쿠","8. 큐","9. 크","10. 키"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_17(
                                id: widget.index,
                              ),
                            ),
