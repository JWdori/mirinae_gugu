...
import '12_j_youtube.dart';

class video_Body_12_12 extends StatefulWidget {
  video_Body_12_12({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_12_12> {
  ...
  List<String> Questiontitle = ["1. 자", "2. 쟈", "3. 저","4. 져","5. 조","6. 죠","7. 주","8. 쥬","9. 즈","10. 지"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_12(
                                id: widget.index,
                              ),
                            ),
