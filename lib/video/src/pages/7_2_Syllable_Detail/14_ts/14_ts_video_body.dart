...
import '14_ts_youtube.dart';

class video_Body_14_14 extends StatefulWidget {
  video_Body_14_14({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_14_14> {
  ...
  List<String> Questiontitle = ["1. 차", "2. 챠", "3. 처","4. 쳐","5. 초","6. 쵸","7. 추","8. 츄","9. 츠","10. 치"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_14(
                                id: widget.index,
                              ),
                            ),
