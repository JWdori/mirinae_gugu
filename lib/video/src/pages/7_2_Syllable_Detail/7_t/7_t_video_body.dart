...
import '7_t_youtube.dart';

class video_Body_7_7 extends StatefulWidget {
  video_Body_7_7({Key? key, required this.index}) : super(key: key);
  @override
...
class _video_Body extends State<video_Body_7_7> {
  ...
  List<String> Questiontitle = ["1. 타", "2. 탸", "3. 터","4. 텨","5. 토","6. 툐","7. 투","8. 튜","9. 트","10. 티"];
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: 29,
                              itemBuilder: (context, index) => video_page_7(
                                id: widget.index,
                              ),
                            ),
