    ...
    return SafeArea(
      child: Scaffold(
                    ...
                    children: [
                      Align(
                          ...
                          child: Text('행복한\n하루되세요~~', style: TextStyle(
                              fontSize: 16.0.sp+size, fontWeight: FontWeight.bold))
                      ),
                      CircleAvatar(
                        radius: 8.w,
                  ...
                  child: Row(
                        ...
                        Column(
                         ...
                         child: Column(children: <Widget>[
                              Text('학습하기', style: TextStyle(
                                  fontSize: 14.sp+size, color: Colors.black87)),
                                Text('', style: TextStyle(
                                  fontSize: 1.sp,)),
                                Text('조음별 발음 학습', style: TextStyle(
                                  fontSize: 11.sp+size, color: Colors.black54)),
                                ]
                        )
                      )
                            ]
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                                child: Icon(Icons.arrow_forward_ios_sharp,size: 8.w,color: Colors.black54,),
                              ),
    )
]
                        )
        ...
        appBar:  AppBar(
            ...
            title:
            Text('구구절절', style: TextStyle(color: Colors.black,fontSize: 16.sp,fontWeight: FontWeight.bold)),
            centerTitle: true,
          ...
          child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child:Text("공지사항", style: TextStyle(fontSize: 6.sp,color: Colors.black),textAlign: TextAlign.center,),
                      )
                    ],
                  ),
        ),
