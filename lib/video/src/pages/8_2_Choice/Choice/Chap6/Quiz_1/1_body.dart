...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap6/Quiz_1/1_youtube.dart';
...
class _Body_1 extends State<Body_1>{
  ...
  Widget build(BuildContext context) {
    ...
    QuestionController_61 _questionController = Get.put(QuestionController_61());
    return Stack(
      children: [
        SafeArea(
          child: Column(
