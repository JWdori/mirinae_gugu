...
import 'package:mirinae_gugu/video/src/components/Questions/Questions_6.dart';
...
class QuestionController_65 extends GetxController with SingleGetTickerProviderMixin {
  late PageController _pageController;
  PageController get pageController => _pageController;

  static const List quiz = quiz6_3;
  ...
  void checkAns(Question question, int selectedIndex) {
    ...
    Future.delayed(Duration(milliseconds: 500), () {
      if (_questionNumber.value != _questions.length) {
        ...
        Get.delete<QuestionController_65>();
      }
    });
  }
