...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap14/Quiz_5/5_youtube.dart';
...
class _Body_5 extends State<Body_5>{
  ...
  Widget build(BuildContext context) {
    ...
    QuestionController_145 _questionController = Get.put(QuestionController_145());
    return Stack(
      children: [
        SafeArea(
          child: Column(
