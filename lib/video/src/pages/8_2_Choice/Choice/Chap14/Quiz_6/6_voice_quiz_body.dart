...
//
  ...
  List qList =[
    Questions("내 취미는 운동이야"),
    Questions("부모님이랑 같이 있어"),
    Questions("뒤에 일정이 있습니다"),
    Questions("기다리고 있을게"),
    Questions("물 마실래?"),
    Questions("방금 밥 먹었어요"),
    Questions("생일 축하해"),
    Questions("바빠서 안될 것 같아"),
    Questions("다행히 큰 문제 없어"),
    Questions("도서관 가는 중이야"),
  ];
...
/*                    Text("Score : $score /100",style: TextStyle(color : Colors.brown ,
  ...
  void finish() async{
    ...
    await s.setBool("speaking14_3",true);
  }
