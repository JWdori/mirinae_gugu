...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap7/Quiz_5/5_youtube.dart';
...
class _Body_5 extends State<Body_5>{
  ...
  Widget build(BuildContext context) {
    ...
    QuestionController_75 _questionController = Get.put(QuestionController_75());
    return Stack(
      children: [
        SafeArea(
          child: Column(
