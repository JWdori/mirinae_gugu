...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap7/Quiz_3/3_youtube.dart';
...
class _Body_3 extends State<Body_3>{
  ...
  Widget build(BuildContext context) {
    ...
    QuestionController_73 _questionController = Get.put(QuestionController_73());
    return Stack(
      children: [
        SafeArea(
          child: Column(
