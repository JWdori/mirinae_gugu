...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap4/Quiz_5/5_option.dart';
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap4/Quiz_5/5_quiz_controller.dart';
...
class ayotube_5 extends StatefulWidget {
  ...
  class _ayotube_5 extends State<ayotube_5>{
    ...
    List asd = ['0','iGhji-x12zE','jeVa85FyWLQ','QYO31_wQvUo','EEG3VJlr-xo','0NQSH_rd3LA','w31xY-rEP3Q','Qtz3A3tE0tU','ZHCaP0h8kcM','fans0O1JtN4'];
...
//테두리
  ...
  Widget build(BuildContext context) {
    ...
    QuestionController_45 _controller = Get.put(QuestionController_45());
    return Container(
      child: Column(
        children: [
          Container(
