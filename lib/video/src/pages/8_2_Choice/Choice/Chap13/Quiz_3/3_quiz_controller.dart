...
import 'package:mirinae_gugu/video/src/components/Questions/Questions_13.dart';
...
class QuestionController_133 extends GetxController with SingleGetTickerProviderMixin {
  late PageController _pageController;
  PageController get pageController => _pageController;

  static const List quiz = quiz13_2;
  ...
  void checkAns(Question question, int selectedIndex) {
    ...
    Future.delayed(Duration(milliseconds: 500), () {
      if (_questionNumber.value != _questions.length) {
        ...
        Get.delete<QuestionController_133>();
      }
    });
  }
