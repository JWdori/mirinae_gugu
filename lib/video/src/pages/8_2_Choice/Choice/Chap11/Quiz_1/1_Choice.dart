...
import 'package:mirinae_gugu/video/src/pages/8_2_Choice/Choice/Chap11/Quiz_1/1_body.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class Choice111 extends StatelessWidget {
  void finish() async{
    SharedPreferences s = await SharedPreferences.getInstance();
    s.setBool("reading11_1",true);
  }
  @override
