...
import 'package:mirinae_gugu/video/src/pages/5_Education/5_4_body/5_4_pageview_man.dart';

class video_Body_4 extends StatefulWidget {
  video_Body_4({Key? key, required this.index}) : super(key: key);
...
class _video_Body extends State<video_Body_4> {
