...
import 'package:mirinae_gugu/video/src/pages/5_Education/5_3_body/5_3video_body.dart';
import 'package:mirinae_gugu/video/src/widget/learn_level_button_f.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Vocab_Screen_53 extends StatefulWidget {
  @override
  _Vocab_Screen_51 createState() => _Vocab_Screen_51();
}

class _Vocab_Screen_51 extends State<Vocab_Screen_53>{
  ...
  Future<void> loadFavorite() async{
    ...
    setState((){
      FavoriteButtons = (prefs.getStringList("favorite_3") ?? <bool>[]).map((value) => value == 'true').toList();
    });
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                              ...
                              text: FavoriteButtons[1] ? "3-1" : '3-1',
                              onTap: () async {
                                await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                  index:1,
                                ),));
                              }
                          ),
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[2] ? '3-2' : '3-2',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 2,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[3] ? '3-3' : '3-3',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 3,
                              ),));
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[4] ? '3-4' : '3-4',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 4,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[5] ? '3-5' : '3-5',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 5,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[6] ? '3-6' : '3-6',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 6,
                              ),));
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[7] ? '3-7' : '3-7',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 7,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[8] ? '3-8' : '3-8',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 8,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[9] ? '3-9' : '3-9',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 9,
                              ),));
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[10] ? '3-10' : '3-10',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 10,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[11] ? '3-11' : '3-11',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 11,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[12] ? '3-12' : '3-12',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 12,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[13] ? '3-13' : '3-13',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 13,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[14] ? '3-14' : '3-14',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 14,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[15] ? '3-15' : '3-15',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 15,
                                //Level newLevel = await gameBloc.setLevel(index + 1);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[16] ? '3-16' : '3-16',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 16,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[17] ? '3-17' : '3-17',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 17,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[18] ? '3-18' : '3-18',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 18,
                                //Level newLevel = await gameBloc.setLevel(index + 1);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[19] ? '3-19' : '3-19',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 19,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[20] ? '3-20' : '3-20',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 20,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[21] ? '3-21' : '3-21',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 21,
                                //Level newLevel = await gameBloc.setLevel(index + 1);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[22] ? '3-22' : '3-22',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 22,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[23] ? '3-23' : '3-23',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 23,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[24] ? '3-24' : '3-24',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 24,
                                //Level newLevel = await gameBloc.setLevel(index + 1);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[25] ? '3-25' : '3-25',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 25,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[26] ? '3-26' : '3-26',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 26,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[27] ? '3-27' : '3-27',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 27,
                                //Level newLevel = await gameBloc.setLevel(index + 1);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[28] ? '3-28' : '3-28',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 28,
                              ),));
                          ...
                          LearnLevelButton(
                            ...
                            text: FavoriteButtons[29] ? '3-29' : '3-29',
                            onTap: () async {
                              await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body_3(
                                index: 29,
                              ),));
