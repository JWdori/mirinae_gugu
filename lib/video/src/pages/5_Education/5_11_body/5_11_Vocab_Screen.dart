...
import '5_11_video_body.dart';


class Vocab_Screen_511 extends StatefulWidget {
  @override
  _Vocab_Screen_51 createState() => _Vocab_Screen_51();
}

class _Vocab_Screen_51 extends State<Vocab_Screen_511>{
  ...
  Future<void> loadFavorite() async{
    ...
    setState((){
      FavoriteButtons = (prefs.getStringList("favorite_11_") ?? <bool>[]).map((value) => value == 'true').toList();
    });
            ...
            child: ListView(
                ...
                children: <Widget>[
                  ...
                  Align(
                      ...
                      child: Text('  낱말 11단원 (30)',style: TextStyle(fontSize: 20.0.sp+size,fontWeight: FontWeight.bold))
                  ),
                  SizedBox(height: 5.h),
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                          ...
                          text: FavoriteButtons[1] ? "11-1" : '11-1',
                          onTap: () async {
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[2] ? '11-2' : '11-2',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                              index: 2,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[3] ? '11-3' : '11-3',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 3,
                          ),));
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[4] ? '11-4' : '11-4',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 4,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[5] ? '11-5' : '11-5',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 5,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[6] ? '11-6' : '11-6',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 6,
                          ),));
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[7] ? '11-7' : '11-7',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 7,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[8] ? '11-8' : '11-8',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 8,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[9] ? '11-9' : '11-9',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 9,
                          ),));
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[10] ? '11-10' : '11-10',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 10,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[11] ? '11-11' : '11-11',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 11,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[12] ? '11-12' : '11-12',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 12,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[13] ? '11-13' : '11-13',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 13,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[14] ? '11-14' : '11-14',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 14,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[15] ? '11-15' : '11-15',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 15,
                            //Level newLevel = await gameBloc.setLevel(index + 1);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[16] ? '11-16' : '11-16',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 16,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[17] ? '11-17' : '11-17',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 17,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[18] ? '11-18' : '11-18',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 18,
                            //Level newLevel = await gameBloc.setLevel(index + 1);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[19] ? '11-19' : '11-19',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 19,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[20] ? '11-20' : '11-20',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 20,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[21] ? '11-21' : '11-21',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 21,
                            //Level newLevel = await gameBloc.setLevel(index + 1);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[22] ? '1122' : '11-22',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 22,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[23] ? '11-23' : '11-23',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 23,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[24] ? '11-24' : '11-24',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 24,
                            //Level newLevel = await gameBloc.setLevel(index + 1);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[25] ? '11-25' : '11-25',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 25,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[26] ? '11-26' : '11-26',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 26,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[27] ? '11-27' : '11-27',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 27,
                            //Level newLevel = await gameBloc.setLevel(index + 1);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[28] ? '11-28' : '11-28',
          onTap: () async {
            await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
              index: 28,
            ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[29] ? '11-29' : '11-29',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 29,
                          ),));
                      ...
                      LearnLevelButton(
                        ...
                        text: FavoriteButtons[30] ? '11-30' : '11-30',
                        onTap: () async {
                          await Navigator.push(context, MaterialPageRoute(builder: (context) => video_Body(
                            index: 30,
                          ),));
