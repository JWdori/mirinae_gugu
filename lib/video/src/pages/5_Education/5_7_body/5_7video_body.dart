...
import '5_7pageview.dart';
import 'dart:io';
import 'package:path_provider/path_provider.dart';
import 'package:mirinae_gugu/video/src/pages/6_record/6_audio_recorder.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:permission_handler/permission_handler.dart';
import '5_7_pageview_man.dart';


class video_Body_7 extends StatefulWidget {
  video_Body_7({Key? key, required this.index}) : super(key: key);
...
class _video_Body extends State<video_Body_7> {
...
// You can request multiple permissions at once.
  ...
  Future<void> loadFavorite() async {
    ...
    setState(() {
      favorite = (prefs.getStringList("favorite_7") ?? <bool>[])
  ...
  Future<void> saved() async {
    ...
    await prefs.setStringList(
        "favorite_7", favorite.map((value) => value.toString()).toList());
    if (mounted) {
      setState(() {
        favorite = (prefs.getStringList("favorite_7") ?? <bool>[])
            .map((value) => value == 'true')
